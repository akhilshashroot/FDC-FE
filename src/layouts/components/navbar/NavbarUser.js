  ...
  return (
    <DropdownMenu right>
      <DropdownItem
        tag="a"
        href="#"
        onClick={e => handleNavigation(e, "/docs/settings/change-password")}
      >
          ...
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            <div className="user-nav d-sm-flex d-none">
              <span className="user-name text-bold-600">
                {(this.props.userDetails && this.props.userDetails.userDetails && this.props.userDetails.userDetails.data && this.props.userDetails.userDetails.data.name) ? this.props.userDetails.userDetails.data.name : ""}
              </span>
              <span className="user-status">{(this.props.userDetails && this.props.userDetails.userDetails && this.props.userDetails.userDetails.data && this.props.userDetails.userDetails.data.role) ? this.props.userDetails.userDetails.data.role : ""}</span>
            </div>
          </DropdownToggle>
...
export default connect(mapStateToProps, { userDetailsFetch, logOut })(NavbarUser)
