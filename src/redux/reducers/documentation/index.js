const DocumentReducer = (state = {}, action) => {
    ...
    // Add New Document
        ...
        case "ADD_DOCUMENT_ERROR": {
            return { ...state, addDocumentError: action.payload, addedDocument : "",isLoading: false }
        }
    ...
    // Get All Document
        ...
        case "GET_ALL_DOCUMENT_REQUEST": {
          ...
          case "GET_ALL_DOCUMENT_FAILURE": {
            return { ...state, allDocumentData: action.data, allDocumentLoading: false }
          }
    ...
    // Get Particular Document
            ...
            case "GET_DOCUMENT_FAILURE": {
                return { ...state, particularDocumentDataFailure: action.data, documentDataLoading: false }
            }
            ...
            case "UPDATE_DOCUMENT_REQUEST": {
              ...
              case "UPDATE_DOCUMENT_ERROR": {
                return { ...state, documentUpdatedError: action.payload, documentDataLoading: false }
              }
