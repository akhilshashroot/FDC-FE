const KbaseReducer = (state = {}, action) => {
    ...
    // Add New Article
        ...
        case "ADD_ARTICLE_ERROR": {
            return { ...state, addArticleError: action.payload, addedArticle : "",isLoading: false }
        }
    ...
    // Get Particular Article
            ...
            case "GET_KBASE_ARTICLE_FAILURE": {
                return { ...state, allKbaseArticleData: action.data, articleDataLoading: false }
            }
            ...
            case "UPDATE_ARTICLE_REQUEST": {
              ...
              case "UPDATE_ARTICLE_ERROR": {
                return { ...state, articleUpdatedError: action.payload, articleDataLoading: false }
              }
      ...
      case "ADD_CATEGORY_ERROR": {
          return { ...state, addCategoryError: action.payload, addedCategory : "",categoryLoading: false }
      }
  ...
  // Get All Category
      ...
      case "GET_ALL_CATEGORY_REQUEST": {
        ...
        case "GET_ALL_CATEGORY_FAILURE": {
          return { ...state, allCategory: "",allCategoryError: action.data, allCategoryLoading: false }
        }
          ...
          case "UPDATE_CATEGORY_REQUEST": {
            ...
            case "UPDATE_CATEGORY_ERROR": {
              return { ...state, categoryUpdatedError: action.payload, categoryUpdatedSuccess: "", categoryDataLoading: false }
            }
