...
import {
    Col, Button, Form, FormGroup, Input, Label, Row,
    Modal,
    ModalBody,
    ModalFooter,
    ModalHeader,
...
class ActiveIpTransitAddEdit extends React.PureComponent {
    state = {
        firstRender: true,
    ...
    submitCancelItem = () => {
        if (this.props.data !== null) {
            ...
            if (this.state.circuit_country !== null) {
                data.circuit_country = this.state.circuit_country && this.state.circuit_country.value ? this.state.circuit_country.value : "";
            }
        ...
        return (
            <Fragment>
                ...
                >
                    ...
                    >
                        {data !== null ? "Update Active IP Transit" : "Add Active IP Transit"}
                    </ModalHeader>
...
export default ActiveIpTransitAddEdit