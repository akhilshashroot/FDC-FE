...
class Export extends React.Component {
    ...
    exportPDF = () => {
        ...
        const headers = [["Sl.No", "Provider", "Client Id", "Service Id", "Circuit Id", "Circuit Type", "Circuit Country",
            "Circuit City", "Port Capacity", "Bandwidth Commit", "Activation Date", "Expiration Date",
            "Metered Charge", "Status", "Notes"]];

        const data = this.props.data.map(elt => [elt.index, elt.provider, elt.client_id, elt.sid, elt.circuit_id,
        elt.circuit_type, elt.circuit_country, elt.circuit_city, elt.port_capacity, elt.bandwidth,
