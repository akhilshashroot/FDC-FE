...
class DocumentAdd extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      user: user_role === "Senior Sales" ? "" : { label: "Admin", value: 1 },
    });
    ...
    if (this.state.topic === "" || this.state.topic == null) {
      ...
      this.props.AddNewDocument(Data).then(() => {
        if (
          ...
          this.props.DocumentationList.addedDocument
        ) {
          this.props.Added();
          this.props.docsAdd();
        } else {
          if (
            this.props.DocumentationList &&
            this.props.DocumentationList.documentUpdatedError &&
            this.props.DocumentationList.documentUpdatedError.response &&
            this.props.DocumentationList.documentUpdatedError.response.data &&
            this.props.DocumentationList.documentUpdatedError.response.data
              .errors &&
            this.props.DocumentationList.documentUpdatedError.response.data
              .errors.doc_name &&
            this.props.DocumentationList.documentUpdatedError.response.data
              .errors.doc_name[0] === "The doc name has already been taken."
          ) {
                      ...
                      <Col sm="4">
                        <FormGroup>
                          ...
                          <Select
                            ...
                            options={this.convertLocation(
                              this.props.locationList &&
                                this.props.locationList.allData
                            )}
                            isSearchable={true}
                          />
                        </FormGroup>
